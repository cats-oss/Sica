...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Animation: do {
            ...
            animator.delay(4)
                .addBasicAnimation(keyPath: .positionY, value: (from: v[0], to: v[1]), duration: d[0], timingFunction: timingFunctions[0])
                .addBasicAnimation(keyPath: .positionY, value: (from: v[1], to: v[2]), duration: d[1], timingFunction: timingFunctions[1])
                .addBasicAnimation(keyPath: .positionY, value: (from: v[2], to: v[3]), duration: d[2], timingFunction: timingFunctions[2])
                .addBasicAnimation(keyPath: .positionY, value: (from: v[3], to: v[4]), duration: d[3], timingFunction: timingFunctions[3])
